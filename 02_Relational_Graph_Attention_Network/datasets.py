...
def get_dataset(dataset_name):
    ...
    mobasa_train = 'data/mobasa/MobASA_Train_Clean_biaffine_depparsed.json'
    mobasa_test = 'data/mobasa/MobASA_Test_Clean_biaffine_depparsed.json'
    ...
    germeval_train ='data/studycheck/StudyCheck_Train_Clean_biaffine_depparsed_without_large.json'
    germeval_test = 'data/studycheck/StudyCheck_Test_Clean_biaffine_depparsed_without_large.json'

    ds_train = {'rest': rest_train,
                'laptop': laptop_train, 'mobasa': mobasa_train, 'trieout': trieout_train, 'germeval': germeval_train}
    ds_test = {'rest': rest_test,
               'laptop': laptop_test, 'mobasa': mobasa_test, 'trieout': trieout_test, 'germeval': germeval_test}
